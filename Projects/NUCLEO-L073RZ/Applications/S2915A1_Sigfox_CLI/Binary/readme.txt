...
---------------------------
1. SFX_S2915A1_CLI_L0.bin : This binary provides the connectivity of NUCLEO-L073RZ + X-NUCLEO-S2915A1 to the GUI and sends the Sigfox packet using the PC-GUI.
