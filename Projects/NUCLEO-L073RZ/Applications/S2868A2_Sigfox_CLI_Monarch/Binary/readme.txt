...
---------------------------
1. SFX_S2868A1_CLI_MON_L0.bin : This binary provides the connectivity of NUCLEO-L073RZ + X-NUCLEO-S2868A2 to the GUI and sends the Sigfox packet using the PC-GUI.
