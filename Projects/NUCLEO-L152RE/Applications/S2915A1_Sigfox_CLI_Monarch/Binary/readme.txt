...
---------------------------
1. SFX_S2915A1_CLI_MON_L1.bin : This binary provides the connectivity of NUCLEO-L152RE + X-NUCLEO-S2915A1 to the GUI and sends the Sigfox packet using the PC-GUI.
