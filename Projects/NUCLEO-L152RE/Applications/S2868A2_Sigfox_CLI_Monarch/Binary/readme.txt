...
---------------------------
1. SFX_S2868A2_CLI_MON_L1.bin : This binary provides the connectivity of NUCLEO-L152RE + X-NUCLEO-S2868A2 to the GUI and sends the Sigfox packet using the PC-GUI.
