...
---------------------------
1. SFX_S2868A2_CLI_L4.bin : This binary provides the connectivity of NUCLEO-L476RG + X-NUCLEO-S2868A2 to the GUI and sends the Sigfox packet using the PC-GUI.
