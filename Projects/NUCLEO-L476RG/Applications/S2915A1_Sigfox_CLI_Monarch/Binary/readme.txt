...
---------------------------
1. SFX_S2915A1_CLI_MON_L4.bin : This binary provides the connectivity of NUCLEO-L476RG + X-NUCLEO-S2915A1 to the GUI and sends the Sigfox packet using the PC-GUI.
