...
#define RadioEnterShutdown                      S2868A2_RADIO_EnterShutdown
#define RadioExitShutdown                       S2868A2_RADIO_ExitShutdown
...
#define S2LP_RADIO_GPIO                                  S2868A2_RADIO_GPIO_0
#endif
#if (USE_S2868A2_RADIO_GPIO_1 == 1)
#define S2LP_GPIO_IRQ_PIN                         	1
#define S2LP_RADIO_GPIO                                  S2868A2_RADIO_GPIO_1
#endif
#if (USE_S2868A2_RADIO_GPIO_2 == 1)
#define S2LP_GPIO_IRQ_PIN                         	2
#define S2LP_RADIO_GPIO                                  S2868A2_RADIO_GPIO_2
#endif
#if (USE_S2868A2_RADIO_GPIO_3 == 1)
#define S2LP_GPIO_IRQ_PIN                         	3
#define S2LP_RADIO_GPIO                                  S2868A2_RADIO_GPIO_3
#endif
