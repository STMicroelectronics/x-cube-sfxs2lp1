...
* @param  ch: Input char
* @retval Returns a value > 15 if ch is not a hex digit.
*/
...
/**
* @brief  returns token length.
* @param  num: Number
* @retval Returns token length.
*/
...
/**
* @brief  returns token pointer.
* @param  tokenNum: token number
* @retval Returns token pointer.
*/
...
/**
* @brief  This is a state machine for parsing commands.  If 'input' is NULL
*         'sizeOrPort' is treated as a port and characters are read from there.
* @param  input: pointer to input
* @param sizeOrPort: a port and characters are read from there.
...
/**
* @brief  Returns first byte of arguments
...
/**
* @brief  Converts in lower case
* @param  c: input char
* @retval lower case char.
*/
static uint8_t charDowncase(uint8_t c)
{
  if ('A' <= c && c <= 'Z')
...
/**
* @brief  Command look up
* @param  commandFinger: pointer to command fingure
* @retval tokenNum : token number.
*/
...
* @param  argNum : argument number
* @param  swallowLeadingSign: Leading sign
* @retval unsigned int
*/
static uint32_t stringToUnsignedInt(uint8_t argNum, uint8_t swallowLeadingSign)
{
...
/**
* @brief  Copy String command argument
* @param  argNum : argument number
* @param  destination : pointer to destination
* @param  maxLength : maximum length
* @param  leftPad : left padding length 
...
/**
* @brief  Gets current command fingure
* @param  none
* @retval Retruns the value of caller
*/
