/**
  ...
  * @brief   Driver for response management
  ******************************************************************************
  * @attention
  *
...
/**
* @brief  Header printf.
* @param  formatString: Pointer to string
* @param  string: Pointer to the string
* @retval Status of operation
*/
...
/**
* @brief  Response printf flexible.
* @param  flushapp: Pointer to flushapp
* @param  formatString: Pointer to string
* @retval Status of operation
*/
uint8_t responsePrintfFlexible(printfFlushHandler *flushapp,
